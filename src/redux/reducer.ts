...
function filterFromObject<K extends string | number | symbol, V>(
    ...
    return Object.fromEntries(
        (Object.entries(objectToFilter) as Array<[K, V]>).filter(filterMethod)
    ) as Record<K, V>;
}
...
export const reducer = createReducer(initialState, (builder) => {
    ...
    builder.addCase(
        SIGNIN_CALLBACK_ERROR,
        (state, action: SignInCallbackErrorAction) => {
    ...
    builder.addCase(
        SELECT_COMPUTED_LANGUAGE,
        (state, action: ComputedLanguageAction) => {
    ...
    builder.addCase(
        CURRENT_CHILDREN,
        (state, action: CurrentChildrenAction) => {
    ...
    builder.addCase(
        SELECT_DIRECTORY,
        (state, action: SelectDirectoryAction) => {
    ...
    builder.addCase(
        ACTIVE_DIRECTORY,
        (state, action: ActiveDirectoryAction) => {
    ...
    builder.addCase(
        SEARCHED_ELEMENT,
        (state, action: SearchedElementAction) => {
    ...
    builder.addCase(
        SET_APPS_AND_URLS,
        (state, action: SetAppsAndUrlsAction) => {
    ...
    builder.addCase(
        ADD_UPLOADING_ELEMENT,
        (state, action: AddUploadingElementAction) => {
    ...
    builder.addCase(
        REMOVE_UPLOADING_ELEMENT,
        (state, action: RemoveUploadingElementAction) => {
    ...
    builder.addCase(
        DIRECTORY_UPDATED,
        (state, action: DirectoryUpdatedAction) => {
