...
const ImportParametersFr = {
    ...
    // IIDM
    'iidm.import.xml.throw-exception-if-extension-not-found': "Exception si une extension n'est pas connue",
    ...
    'iidm.import.xml.extensions.branchObservability': 'Observabilité des quadripôles',
    ...
    'iidm.import.xml.extensions.cgmesTapChangers': 'Cgmes - lois de réglage et déphasage',
    'iidm.import.xml.extensions.cimCharacteristics': 'Cgmes - caractéristiques',
    'iidm.import.xml.extensions.coordinatedReactiveControl': 'Contrôle coordonné du réactif',
    'iidm.import.xml.extensions.detail': 'Données détaillées des consommations (fixe | affine)',
    'iidm.import.xml.extensions.discreteMeasurements': 'Télémesures (Régleurs et Déphaseurs)',
    'iidm.import.xml.extensions.entsoeArea': 'Zone Entsoe',
    'iidm.import.xml.extensions.entsoeCategory': 'Catégorie Entsoe des groupes',
    'iidm.import.xml.extensions.generatorActivePowerControl': 'Compensation (Groupes)',
    ...
    'iidm.import.xml.extensions.generatorAsymmetrical': 'Données pour les calculs dissymétriques des groupes',
    'iidm.import.xml.extensions.generatorRemoteReactivePowerControl':
        'Régulation à distance de la puissance réactive des groupes',
    'iidm.import.xml.extensions.generatorShortCircuit': 'Données de court-circuit des groupes',
    'iidm.import.xml.extensions.generatorShortCircuits': 'Données de court-circuit des groupes (Version IIDM 1.0)',
    'iidm.import.xml.extensions.hvdcAngleDroopActivePowerControl': 'Emulation AC pour les HVDCs',
    'iidm.import.xml.extensions.hvdcOperatorActivePowerRange': 'Limites de transits des HVDCs',
    'iidm.import.xml.extensions.identifiableShortCircuit': 'Données de court-circuit des postes',
    'iidm.import.xml.extensions.injectionObservability': 'Observabilité des injections',
    // to remove after powsybl september release
    'iidm.import.xml.extensions.lineFortescue': 'Données pour les calculs dissymétriques des lignes',
    'iidm.import.xml.extensions.lineAsymmetrical': 'Données pour les calculs dissymétriques des lignes',
    'iidm.import.xml.extensions.linePosition': 'Coordonnées géographiques de lignes',
    // to remove after powsybl september release
    'iidm.import.xml.extensions.loadFortescue': 'Données pour les calculs dissymétriques des consommations',
    'iidm.import.xml.extensions.loadAsymmetrical': 'Données pour les calculs dissymétriques des consommations',
    'iidm.import.xml.extensions.measurements': 'Télémesures',
    'iidm.import.xml.extensions.mergedXnode': 'Xnode mergé',
    'iidm.import.xml.extensions.operatingStatus': 'Statut de consignation et de déclenchement',
    ...
    'iidm.import.xml.extensions.referenceTerminals': 'Terminaux référence de phase (Calcul de répartition)',
    'iidm.import.xml.extensions.secondaryVoltageControl': 'Réglage secondaire de tension',
    ...
    'iidm.import.xml.extensions.substationPosition': 'Coordonnées géographiques des sites',
    // to remove after powsybl september release
    ...
    'iidm.import.xml.extensions.voltageLevelShortCircuits': 'Données de court-circuit des postes (Version IIDM 1.0)',
...
export default ImportParametersFr;
