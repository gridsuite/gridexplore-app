...
const ImportParametersEn = {
    ...
    'iidm.import.xml.extensions.coordinatedReactiveControl': 'Coordinated reactive control',
    ...
    'iidm.import.xml.extensions.generatorActivePowerControl': 'Generator active power control',
    // to remove after powsybl september release
    'iidm.import.xml.extensions.generatorFortescue': 'Generator asymmetrical',
    'iidm.import.xml.extensions.generatorAsymmetrical': 'Generator asymmetrical',
    'iidm.import.xml.extensions.generatorRemoteReactivePowerControl': 'Generator remote reactive power control',
    'iidm.import.xml.extensions.generatorShortCircuit': 'Generator short-circuit',
    'iidm.import.xml.extensions.generatorShortCircuits': 'Generator short-circuit (IIDM version 1.0)',
    'iidm.import.xml.extensions.hvdcAngleDroopActivePowerControl': 'HVDC angle droop active power control',
    'iidm.import.xml.extensions.hvdcOperatorActivePowerRange': 'HVDC operator active power range',
    'iidm.import.xml.extensions.identifiableShortCircuit': 'Identifiable short-circuit',
    'iidm.import.xml.extensions.injectionObservability': 'Injection observability',
    // to remove after powsybl september release
    ...
    'iidm.import.xml.extensions.referencePriorities': 'Reference priorities (LoadFlow)',
    'iidm.import.xml.extensions.referenceTerminals': 'Reference terminals (LoadFlow)',
    'iidm.import.xml.extensions.secondaryVoltageControl': 'Secondary voltage control',
    'iidm.import.xml.extensions.slackTerminal': 'Slack terminal',
    'iidm.import.xml.extensions.standbyAutomaton': 'Static var compensators automaton',
    ...
    'iidm.import.xml.extensions.threeWindingsTransformerAsymmetrical': 'Three windings transformer asymmetrical',
    'iidm.import.xml.extensions.threeWindingsTransformerPhaseAngleClock':
        'Three windings transformer phase angle clock',
    'iidm.import.xml.extensions.threeWindingsTransformerToBeEstimated': 'Three windings transformer to be estimated',
    // to remove after powsybl september release
    'iidm.import.xml.extensions.twoWindingsTransformerFortescue': 'Two windings transformer asymmetrical',
    'iidm.import.xml.extensions.twoWindingsTransformerAsymmetrical': 'Two windings transformer asymmetrical',
    'iidm.import.xml.extensions.twoWindingsTransformerPhaseAngleClock': 'Two windings transformer phase angle clock',
    'iidm.import.xml.extensions.twoWindingsTransformerToBeEstimated': 'Two windings transformer to be estimated',
    'iidm.import.xml.extensions.voltageLevelShortCircuits': 'Voltage level short circuits',
