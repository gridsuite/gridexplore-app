        ...
        () =>
            new Map<ModificationType, SpecificModificationDialogProps>([
                ...
                [
                    ...
                    {
                        formSchema: limitSetsTabularModificationFormSchema,
                        dtoToForm: limitSetsTabularModificationDtoToForm,
                        formToDto: limitSetsTabularModificationFormToDto,
                        errorHeaderId: 'TabularModificationError',
                        titleId: 'LimitSetsTabularModification',
                        ModificationForm: LimitSetsTabularModificationForm,
                        removeOptional: false,
                        unscrollableFullHeight: true,
                    },
                ],
