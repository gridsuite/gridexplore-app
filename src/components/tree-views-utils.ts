...
export function mapFromRoots(roots: IDirectory[]): Record<string, IDirectory> {
...
export function pathHasChanged(currentPath: ElementAttributes[], newPath: ElementAttributes[]) {
    return (
